...
import static it.pagopa.pn.stream.exceptions.PnStreamExceptionCodes.ERROR_CODE_STREAM_AUDITLOGFAILED;
        ...
        if (StringUtils.hasText(mandateId)) {
            ...
            if (isRequestFromSender) {
                ...
                if (isRequestFromRecipient) {
                    ...
                    throw new PnInternalException("Request is not from any authorized user. The audit log type cannot be determined - iun=" + notification.getIun() + " senderRecipientId=" + senderRecipientId + " mandateId=" + mandateId, ERROR_CODE_STREAM_AUDITLOGFAILED);
                }
            }
        }
    }
