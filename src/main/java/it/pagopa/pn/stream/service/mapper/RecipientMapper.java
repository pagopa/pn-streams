...
import it.pagopa.pn.stream.dto.ext.delivery.notification.*;
import it.pagopa.pn.stream.dto.address.PhysicalAddressInt;
import it.pagopa.pn.stream.dto.ext.datavault.RecipientTypeInt;
import it.pagopa.pn.stream.generated.openapi.msclient.delivery.model.NotificationDigitalAddress;
import it.pagopa.pn.stream.generated.openapi.msclient.delivery.model.NotificationPaymentItem;
...
import static it.pagopa.pn.stream.service.mapper.PaymentMapper.getNotificationPaymentInfo;
import static it.pagopa.pn.stream.service.mapper.PaymentMapper.getNotificationPaymentItem;
