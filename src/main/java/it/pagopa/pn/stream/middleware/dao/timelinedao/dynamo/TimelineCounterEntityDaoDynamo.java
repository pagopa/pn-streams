...
import it.pagopa.pn.stream.middleware.dao.timelinedao.dynamo.entity.TimelineCounterEntity;
...
public class TimelineCounterEntityDaoDynamo extends AbstractDynamoKeyValueStore<TimelineCounterEntity> implements TimelineCounterEntityDao {
    ...
    protected TimelineCounterEntityDaoDynamo(DynamoDbEnhancedClient dynamoDbEnhancedClient, PnStreamConfigs cfg) {
