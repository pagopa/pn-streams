...
import it.pagopa.pn.stream.dto.timeline.details.ContactPhaseInt;
import it.pagopa.pn.stream.dto.timeline.details.DeliveryModeInt;
...
class TimelineEventIdBuilderTest {
    ...
    void buildSEND_COURTESY_MESSAGE_OPTINTest() {
        ...
        String timeLineEventIdActual = new TimelineEventIdBuilder()
                ...
                .withIun(IUN)
                .withRecIndex(0)
                .withCourtesyAddressType(CourtesyDigitalAddressInt.COURTESY_DIGITAL_ADDRESS_TYPE_INT.APPIO)
